YUI.add('todo-app', function (Y) {
  ...
  // -- Main Application --------------
  Y.namespace('TodoMVC').TodoApp = Y.Base.create('todoApp', Y.App, [], {
    ...
    addViews: function () {
      ...
      //models.each(function (model) {
        //var view = new Y.TodoMVC.TodoView({model: model});
      ...
      if (!this.todoListView) {
        this.todoListView = new Y.TodoMVC.TodoListView({container: '#todo-list', modelList: models});
      }
  ...
  requires: ['app', 'todo', 'todos', 'todo-view', 'node', 'todo-list']
});
